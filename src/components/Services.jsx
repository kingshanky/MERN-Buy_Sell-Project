                                ...
                                <div className="card-flyer  ">
                                    <div className="text-box img1">
                                        ...
                                        <div className="text-container  Color">
                                            ...
                                            <a href="" onClick={() => history.push('/Aptitude')} className='btn btn-outline-primary rounded-pill px-4    btn1'>Click Me</a>
                            ...
                            <a href="">
                                <div className="card-flyer ">
                                    <div className="text-box img1 ">
                                        ...
                                        <div className="text-container   Color">
                                            <h6>Gov. Job Prepration </h6>
                                            <p>This Page will help you to give proper plan or tips how to prepare for Government Job. How to crack government exam in easy way.  </p>


                                            <a href="" onClick={() => history.push('/Govjob')} className='btn btn-outline-primary rounded-pill px-4    btn2'>Click Me</a>
                                ...
                                <div className="card-flyer ">
                                    <div className="text-box img1">
                                        ...
                                        <div className="text-container    Color">
                                            ...
                                            <a href="" onClick={() => history.push('/Ssb')} className='btn btn-outline-primary rounded-pill px-4    btn3'>Click Me</a>
                                ...
                                <div className="card-flyer  ">
                                    <div className="text-box img1">
                                        ...
                                        <div className="text-container    Color">
                                            ...
                                            <a href="" onClick={() => history.push('/ITjob')} className='btn btn-outline-primary rounded-pill px-4    btn1'>Click Me</a>
                                ...
                                <div className="card-flyer ">
                                    <div className="text-box img1">
                                        ...
                                        <div className="text-container   Color">
                                            ...
                                            <a href="" onClick={() => history.push('/Iasnotes')} className='btn btn-outline-primary rounded-pill px-4    btn2'>Click Me</a>
                                ...
                                <div className="card-flyer ">
                                    <div className="text-box img1">
                                        ...
                                        <div className="text-container    Color">
                                            ...
                                            <a href="" onClick={() => history.push('/Cat')} className='btn btn-outline-primary rounded-pill px-4    btn3'>Click Me</a>
                                ...
                                <a href="">
                                    <div className="card-flyer  ">
                                        <div className="text-box img1">
                                            ...
                                            <div className="text-container    Color">
                                                <h6>Sell Books and Novels</h6>
                                                <p>This Page will help you to  Sell 2nd hand book and Novels.</p>

                                                <a href="" onClick={() => history.push('/SellBooks')} className='btn btn-outline-primary rounded-pill px-4    btn1'>Click Me</a>
                                ...
                                <a href="">
                                    <div className="card-flyer ">
                                        <div className="text-box img1">
                                            ...
                                            <div className="text-container   Color">
                                                <h6>Buy 2nd Hand Books </h6>
                                                <p>This Page will help you to give 2nd hand School books</p>


                                                <a href="" onClick={() => history.push('/School_Books')} className='btn btn-outline-primary rounded-pill px-4    btn2'>Click Me</a>
                                ...
                                <a href="">
                                    <div className="card-flyer ">
                                        <div className="text-box img1">
                                            ...
                                            <div className="text-container    Color">
                                                <h6>Buy 2nd Hand Novels</h6>
                                                <p>This Page will help you to Provide 2nd hand novels in less Price </p>

                                                <a href="" onClick={() => history.push('/Novels')} className='btn btn-outline-primary rounded-pill px-4    btn3'>Click Me</a>
