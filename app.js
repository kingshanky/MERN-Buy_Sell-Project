...
app.post('/bookdetails', async (req, res) => {
    ...
    try {
        ...
        const indianState = req.body.indianState;
        ...
        const createds = await bookdetail.save();
...
app.get("*", function (_, res) {
    res.sendFile(
        path.join(__dirname, './mypro/build/index.html'),
        function (err) {
            if (err) {
...
if (process.env.NODE_ENV === 'production') {
    ...
    app.get("*", (req, res) => {
        res.sendFile(path.resolve(__dirname, 'mypro', 'build', './mypro/build/index.html'));
    })
}
